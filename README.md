...
The application is built using **Python, Scikit-learn, Streamlit, and SHAP**.
...
4. The direction of each factor's influence (positive or negative)
...
Model Performance
Using the current train/test split:
